            ...
            <div className="container mx-auto px-4 lg:px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h4 className="text-xl font-bold tracking-tighter text-white mb-4">idbusiness.co</h4>
                    ...
                    {/* Links */}
                    <div>
                        <h5 className="text-sm font-semibold text-white mb-4 uppercase tracking-wider">Explore</h5>
                    ...
                    {/* Legal / Social */}
                    <div>
                        <h5 className="text-sm font-semibold text-white mb-4 uppercase tracking-wider">Connect</h5>
                        <div className="flex gap-4 text-zinc-400 mb-6">
